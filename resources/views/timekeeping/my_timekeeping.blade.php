    ...
    <div class='col-xl-6'>
         <div class="card card-height-100">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1 py-1">My Hours <button class='btn btn-sm btn-danger' onclick="printTable()">Print</button></h4>
                ...
                <div class="table-responsive table-card" id='table-container'>
                    <table  class="table table-bordered table-nowrap table-centered align-middle mb-0">
                        <thead class="table-light">
                            ...
                            <tr>
                                <th scope="col" colspan=2>Name: {{auth()->user()->name}}</th>
