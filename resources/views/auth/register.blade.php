...
<div class="modal-overlay" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; 
    ...
    <div class="modal-content bg-white rounded shadow-lg p-4" style="max-width:800px; max-height:85vh; overflow-y:auto; position:relative;">
        ...
        <p>By using Saltii, you agree to the terms of this Privacy Policy.</p>
        ...
        <ul>
            ...
            <li><strong>Payment Information:</strong> Saltii uses Stripe for secure payment processing. Stripe may collect your Name, Card Number, CVV, and Expiration Date. We do not store your payment details. Please refer to Stripe’s <a href="https://stripe.com/privacy" target="_blank">Privacy Policy</a> for more information.</li>
        </ul>
