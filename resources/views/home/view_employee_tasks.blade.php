...
<div class="modal fade" id="ongoing_tasks{{$member->id}}" tabindex="-1" aria-labelledby="ongoing_tasks{{$member->id}}_label" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0">
            <div class="modal-header p-3 bg-warning-subtle">
                <h5 class="modal-title" id="ongoing_tasks{{$member->id}}_label">Ongoing Tasks</h5>
            ...
            <div class="modal-body">
                <div class="table-responsive table-card">
                    <table class="table table-borderless table-nowrap table-centered align-middle mb-0">
                        ...
                        <tbody>
                            @foreach($member->tasks->sortBy('due_date') as $task)
