    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0">
            <div class="modal-header p-3">
                <div>
                    <h5 class="modal-title" id="creatertaskModalLabel">Create a task</h5>
                    <p class="text-muted mb-0 mt-1 fs-12">Capture the outcome, deadline, and priority.</p>
                </div>
                ...
                <form method='POST' action='{{url('new-task-home')}}' onsubmit="show();"   enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-12">
                            ...
                            <select class="form-control required select2" name='project' id='project' required>
                        ...
                        <div class="col-lg-12">
                            ...
                            <input type="text" class="form-control" id="sub-tasks" placeholder="Example: Review the launch brief" name="task" maxlength="160" required>
                        </div>
                        <!--end col-->
                        <div class="col-lg-12">
